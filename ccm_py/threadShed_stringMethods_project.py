...
# daily_transactions = daily_sales_replaced.split() #wrong
...
# print(daily_transactions_split[0][0])
...
for transaction in daily_transactions_split:
    ...
    transaction_clean = []
    for data_point in transaction:
        # transactions_clean.append(str(data_point.strip()))
